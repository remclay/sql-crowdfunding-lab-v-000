...
"SELECT projects.title, (pledges.amount - projects.funding_goal) FROM projects JOIN pledges ON projects.id = pledges.project_id WHERE pledges.amount < projects.funding_goal;"
end
